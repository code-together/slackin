...
export default function splash({
    name, org, logo, active, total, channels, iframe
}) {
    let div = dom('.splash', !iframe && dom('.logos',
      ...
      dom('b.total', total), ' registered.'
        ...
        dom('form',
            ...
            dom('input.form-item type=email placeholder=you@yourdomain.com ' + (!iframe ? 'autofocus' : '')),
        ...
        dom("div.related-links", dom("div.mentorship",
            dom("a href=https://docs.google.com/forms/d/1C1-05MVmWO83zk8TV2PJDIBH99vyhfMlB4ZqOYl8dmQ/viewform", "Apply for Mentorship"),
            dom("a href=https://github.com/code-together/mentorship/blob/master/mentors-guide.md", "Do You Want To Be A Mentor?"),
            dom("a href=https://www.reddit.com/r/india/search?q=Weekly+Coders%2C+Hackers+%26+All+Tech+related+thread+author%3Aavinassh&amp;restrict_sr=on&amp;sort=new&amp;t=all", "Hackers Thread /r/india"))), !iframe && dom('footer',
            'powered by ',
...
function style({
    ...
    css.add('.splash', {
        'width': iframe ? '250px' : '500px',
        'margin': iframe ? '0' : '200px auto',
        'text-align': 'center',
        'font-family': '"Helvetica Neue", Helvetica, Arial'
    });

    css.add(".related-links a", {
    ...
    css.add(".related-links a:last-child::after", {
        "content": '""'
    });
